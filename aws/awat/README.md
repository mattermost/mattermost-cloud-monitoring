...
| <a name="input_awat_aurora_family"></a> [awat\_aurora\_family](#input\_awat\_aurora\_family) | n/a | `string` | n/a | yes |
| <a name="input_awat_bucket_tags"></a> [awat\_bucket\_tags](#input\_awat\_bucket\_tags) | Tags for AWAT s3 bucket | `map(string)` | n/a | yes |
...
| <a name="input_awat_db_cluster_engine_version"></a> [awat\_db\_cluster\_engine\_version](#input\_awat\_db\_cluster\_engine\_version) | n/a | `string` | `"14.10"` | no |
