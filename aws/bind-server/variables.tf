...
variable "vpc_id" {
  type        = string
  description = "The VPC ID which will be used in security group"
}

variable "vpn_cidr" {
  type        = list(string)
  description = "The VPC CIDR block which will be used in security group rules"
}

variable "cidr_blocks" {
  type        = list(string)
  description = "The rest of CIDR blocks which will be used in security group rules"
}

variable "teleport_cidr" {
  type        = list(string)
  description = "The Teleport CIDR block which will be used in security group rules"
}
...
variable "ssh_key_public" {
  type        = string
  description = "The public key will be used for the SSH key pair"
}
