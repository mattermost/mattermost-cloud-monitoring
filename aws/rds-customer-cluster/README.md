...
| <a name="input_kms_key_id"></a> [kms\_key\_id](#input\_kms\_key\_id) | ARN for the KMS encryption key if one is set to the cluster | `string` | `""` | no |
...
| <a name="input_primary_region"></a> [primary\_region](#input\_primary\_region) | The region of the primary database cluster | `string` | n/a | yes |
...
| <a name="input_secondary_region"></a> [secondary\_region](#input\_secondary\_region) | The region of the secondary database cluster | `string` | n/a | yes |
