...
| <a name="input_password_encryption"></a> [password\_encryption](#input\_password\_encryption) | The password encryption method to use for the DB instance. Valid values: md5 or scram-sha-256 | `string` | `"scram-sha-256"` | no |
